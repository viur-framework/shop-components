<template>
  <div class="viur-shop-crossselling-header" slot="header">
    <h4 class="viur-shop-crossselling-headline headline">CrossSelling</h4>
  </div>
  <div class="viur-shop-crossselling-cart-item">
    <div>Folgender Artikel wurde in den Warenkorb gelegt</div>
    ...
    <sl-button @click="cancel">Abbrechen</sl-button>
  </div>

  <div  v-for="item in shopStore.state.crossSellingItems" >

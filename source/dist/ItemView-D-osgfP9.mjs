import { reactive as Jt, onBeforeMount as Yt, openBlock as Gt, createElementBlock as Qt, Fragment as Xt, createElementVNode as p, toDisplayString as ht, withModifiers as te, createTextVNode as dt, createVNode as ee } from "vue";
import { Request as ut } from "@viur/vue-utils";
import { useRoute as se } from "vue-router";
import { I as ie } from "./ItemCard-DQpjYKzB.mjs";
import { _ as re } from "./main-DkDkmdKQ.mjs";
function pt(s, t, e) {
 ...
 */
const F = globalThis, nt = F.ShadowRoot && (F.ShadyCSS === void 0 || F.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, at = Symbol(), gt = /* @__PURE__ */ new WeakMap();
let Ut = class {
  constructor(t, e, i) {
...
}, vt = nt ? (s) => s : (s) => s instanceof CSSStyleSheet ? ((t) => {
  let e = "";
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: le, defineProperty: ce, getOwnPropertyDescriptor: he, getOwnPropertyNames: de, getOwnPropertySymbols: ue, getPrototypeOf: pe } = Object, $ = globalThis, ft = $.trustedTypes, ge = ft ? ft.emptyScript : "", Y = $.reactiveElementPolyfillSupport, I = (s, t) => s, W = { toAttribute(s, t) {
  switch (t) {
    case Boolean:
      s = s ? ge : null;
      break;
  ...
  return e;
} }, ct = (s, t) => !le(s, t), mt = { attribute: !0, type: String, converter: W, reflect: !1, hasChanged: ct };
...
class L extends HTMLElement {
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(I("properties"))) {
      const e = this.properties, i = [...de(e), ...ue(e)];
  ...
  _$AK(t, e) {
    ...
    if (r !== void 0 && this._$Em !== r) {
      const n = i.getPropertyOptions(r), l = typeof n.converter == "function" ? { fromAttribute: n.converter } : ((o = n.converter) == null ? void 0 : o.fromAttribute) !== void 0 ? n.converter : W;
...
L.elementStyles = [], L.shadowRootOptions = { mode: "open" }, L[I("elementProperties")] = /* @__PURE__ */ new Map(), L[I("finalized")] = /* @__PURE__ */ new Map(), Y == null || Y({ ReactiveElement: L }), ($.reactiveElementVersions ?? ($.reactiveElementVersions = [])).push("2.0.4");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const O = globalThis, Z = O.trustedTypes, yt = Z ? Z.createPolicy("lit-html", { createHTML: (s) => s }) : void 0, It = "$lit$", w = `lit$${Math.random().toFixed(9).slice(2)}$`, Ot = "?" + w, ve = `<${Ot}>`, E = document, N = () => E.createComment(""), B = (s) => s === null || typeof s != "object" && typeof s != "function", Rt = Array.isArray, fe = (s) => Rt(s) || typeof (s == null ? void 0 : s[Symbol.iterator]) == "function", G = `[ 	
\f\r]`, z = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, bt = /-->/g, _t = />/g, S = RegExp(`>|${G}(?:([^\\s"'>=/]+)(${G}*=${G}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), wt = /'/g, $t = /"/g, Nt = /^(?:script|style|textarea|title)$/i, me = (s) => (t, ...e) => ({ _$litType$: s, strings: t, values: e }), b = me(1), x = Symbol.for("lit-noChange"), v = Symbol.for("lit-nothing"), St = /* @__PURE__ */ new WeakMap(), C = E.createTreeWalker(E, 129);
function Bt(s, t) {
...
const ye = (s, t) => {
  ...
  for (let l = 0; l < e; l++) {
    const a = s[l];
    let d, g, h = -1, y = 0;
    for (; y < a.length && (n.lastIndex = y, g = n.exec(a), g !== null); ) y = n.lastIndex, n === z ? g[1] === "!--" ? n = bt : g[1] !== void 0 ? n = _t : g[2] !== void 0 ? (Nt.test(g[2]) && (r = RegExp("</" + g[2], "g")), n = S) : g[3] !== void 0 && (n = S) : n === S ? g[0] === ">" ? (n = r ?? z, h = -1) : g[1] === void 0 ? h = -2 : (h = n.lastIndex - g[2].length, d = g[1], n = g[3] === void 0 ? S : g[3] === '"' ? $t : wt) : n === $t || n === wt ? n = S : n === bt || n === _t ? n = z : (n = S, r = void 0);
    const _ = n === S && s[l + 1].startsWith("/>") ? " " : "";
    o += n === z ? a + ve : h >= 0 ? (i.push(d), a.slice(0, h) + It + a.slice(h) + w + _) : a + w + (h === -2 ? l : _);
  }
  return [Bt(s, o + (s[e] || "<?>") + (t === 2 ? "</svg>" : "")), i];
};
class H {
  constructor({ strings: t, _$litType$: e }, i) {
    ...
    this.parts = [];
    let o = 0, n = 0;
    const l = t.length - 1, a = this.parts, [d, g] = ye(t, e);
    if (this.el = H.createElement(d, i), C.currentNode = this.el.content, e === 2) {
    ...
    for (; (r = C.nextNode()) !== null && a.length < l; ) {
      if (r.nodeType === 1) {
        if (r.hasAttributes()) for (const h of r.getAttributeNames()) if (h.endsWith(It)) {
          const y = g[n++], _ = r.getAttribute(h).split(w), j = /([.?@])?(.*)/.exec(y);
          a.push({ type: 1, index: o, name: j[2], strings: _, ctor: j[1] === "." ? _e : j[1] === "?" ? we : j[1] === "@" ? $e : K }), r.removeAttribute(h);
        } else h.startsWith(w) && (a.push({ type: 6, index: o }), r.removeAttribute(h));
        if (Nt.test(r.tagName)) {
          const h = r.textContent.split(w), y = h.length - 1;
          if (y > 0) {
            r.textContent = Z ? Z.emptyScript : "";
            for (let _ = 0; _ < y; _++) r.append(h[_], N()), C.nextNode(), a.push({ type: 2, index: ++o });
            r.append(h[y], N());
          }
        }
...
class be {
  ...
  u(t) {
    ...
    for (; a !== void 0; ) {
      if (n === a.index) {
        let d;
        a.type === 2 ? d = new D(o, o.nextSibling, this, t) : a.type === 1 ? d = new a.ctor(o, a.name, a.strings, this, t) : a.type === 6 && (d = new Se(o, this, t)), this._$AV.push(d), a = i[++l];
      }
...
class D {
  ...
  _$AI(t, e = this) {
    t = k(this, t, e), B(t) ? t === v || t == null || t === "" ? (this._$AH !== v && this._$AR(), this._$AH = v) : t !== this._$AH && t !== x && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : fe(t) ? this.k(t) : this._(t);
  }
  S(t) {
  ...
  _(t) {
    this._$AH !== v && B(this._$AH) ? this._$AA.nextSibling.data = t : this.T(E.createTextNode(t)), this._$AH = t;
  }
  $(t) {
    var o;
    ...
    if (((o = this._$AH) == null ? void 0 : o._$AD) === r) this._$AH.p(e);
      ...
      const n = new be(r, this), l = n.u(this.options);
  ...
  k(t) {
    ...
    const e = this._$AH;
    let i, r = 0;
    for (const o of t) r === e.length ? e.push(i = new D(this.S(N()), this.S(N()), this, this.options)) : i = e[r], i._$AI(o), r++;
...
class K {
  ...
  _$AI(t, e = this, i, r) {
    ...
    let n = !1;
    if (o === void 0) t = k(this, t, e, 0), n = !B(t) || t !== this._$AH && t !== x, n && (this._$AH = t);
    else {
      const l = t;
      let a, d;
      for (t = o[0], a = 0; a < o.length - 1; a++) d = k(this, l[i + a], e, a), d === x && (d = this._$AH[a]), n || (n = !B(d) || d !== this._$AH[a]), d === v ? t = v : t !== v && (t += (d ?? "") + o[a + 1]), this._$AH[a] = d;
    }
    n && !r && this.j(t);
  }
  j(t) {
...
Q == null || Q(H, D), (O.litHtmlVersions ?? (O.litHtmlVersions = [])).push("3.1.4");
const Ae = (s, t, e) => {
...
var zt;
R._$litElement$ = !0, R.finalized = !0, (zt = globalThis.litElementHydrateSupport) == null || zt.call(globalThis, { LitElement: R });
...
`, Ht = Object.defineProperty, Ee = Object.getOwnPropertyDescriptor, At = Object.getOwnPropertySymbols, xe = Object.prototype.hasOwnProperty, Pe = Object.prototype.propertyIsEnumerable, Ct = (s, t, e) => t in s ? Ht(s, t, { enumerable: !0, configurable: !0, writable: !0, value: e }) : s[t] = e, Dt = (s, t) => {
  for (var e in t || (t = {}))
    xe.call(t, e) && Ct(s, e, t[e]);
  if (At)
    for (var e of At(t))
      Pe.call(t, e) && Ct(s, e, t[e]);
  return s;
}, c = (s, t, e, i) => {
...
const st = /* @__PURE__ */ new Set(), Me = new MutationObserver(Ft), M = /* @__PURE__ */ new Map();
let jt = document.documentElement.dir || "ltr", Vt = document.documentElement.lang || navigator.language, A;
Me.observe(document.documentElement, {
  attributes: !0,
...
function Ft() {
  jt = document.documentElement.dir || "ltr", Vt = document.documentElement.lang || navigator.language, [...st.keys()].map((s) => {
...
let ke = class {
  ...
  lang() {
    return `${this.host.lang || Vt}`.toLowerCase();
  }
...
var Ue = {
  name: "default",
  resolver: (s, t = !1) => rt(t ? `assets/bootstrap-icons/${s}.svg` : `assets/bootstrap-icons/${s.substring(0, 1)}/${s}.svg`)
}, Ie = Ue, Oe = {
  name: "viur",
  resolver: (s, t = !1) => rt(`/assets/icons/${s}.svg`),
  mutator: (s) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const qe = { attribute: !0, type: String, converter: W, reflect: !1, hasChanged: ct }, Fe = (s = qe, t, e) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Ke = (s, t) => (s == null ? void 0 : s._$litType$) !== void 0;
var U = Symbol(), V = Symbol(), tt, et = /* @__PURE__ */ new Map(), m = class extends T {
  constructor() {
  ...
  async resolveIcon(s, t) {
    ...
    try {
      ...
      if (((e = o == null ? void 0 : o.tagName) == null ? void 0 : e.toLowerCase()) !== "svg")
        return U;
      tt || (tt = new DOMParser());
      const l = tt.parseFromString(o.outerHTML, "text/html").body.querySelector("svg");
  ...
  connectedCallback() {
    super.connectedCallback(), De(this);
  }
  firstUpdated() {
    this.sprite || this.setIcon(), this.initialRender = !0, this.setIcon();
  }
  disconnectedCallback() {
    super.disconnectedCallback(), je(this);
  }
  getIconSource(s = !1) {
  ...
  async setIcon() {
    ...
    let r = et.get(t);
    if (r || (r = this.resolveIcon(t, i), et.set(t, r)), !this.initialRender)
      return;
    const o = await r;
    if (o === V && et.delete(t), t === this.getIconSource().url) {
      if (Ke(o)) {
        this.svg = o;
        return;
      }
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Je = { ATTRIBUTE: 1, CHILD: 2, PROPERTY: 3, BOOLEAN_ATTRIBUTE: 4, EVENT: 5, ELEMENT: 6 }, Ye = (s) => (...t) => ({ _$litDirective$: s, values: t });
class Ge {
  constructor(t) {
  }
  get _$AU() {
...
var u = class extends T {
  constructor() {
    super(...arguments), this.loop = !1, this.navigation = !1, this.pagination = !1, this.autoplay = !1, this.autoplayInterval = 3e3, this.slidesPerPage = 1, this.slidesPerMove = 1, this.orientation = "horizontal", this.mouseDragging = !1, this.activeSlide = 0, this.scrolling = !1, this.dragging = !1, this.autoplayController = new oe(this, () => this.next()), this.localize = new ze(this), this.handleMouseDrag = (s) => {
      ...
      s.style.removeProperty("overflow"), s.style.setProperty("scroll-snap-type", "none"), s.scrollTo({ left: t, top: e, behavior: "instant" }), requestAnimationFrame(async () => {
        ...
        }), await Le(s, "scrollend")), s.style.removeProperty("scroll-snap-type"), this.dragging = !1, this.handleScrollEnd();
      });
  ...
  handleKeyDown(s) {
    if (["ArrowLeft", "ArrowRight", "ArrowUp", "ArrowDown", "Home", "End"].includes(s.key)) {
      const t = s.target, e = this.matches(":dir(rtl)"), i = t.closest('[part~="pagination-item"]') !== null, r = s.key === "ArrowDown" || !e && s.key === "ArrowRight" || e && s.key === "ArrowLeft", o = s.key === "ArrowUp" || !e && s.key === "ArrowLeft" || e && s.key === "ArrowRight";
  ...
  render() {
    const { slidesPerMove: s, scrolling: t } = this, e = this.getPageCount(), i = this.getCurrentPage(), r = this.canScrollPrev(), o = this.canScrollNext(), n = this.matches(":dir(ltr)");
    return b`
...
const ts = { class: "wrap" }, es = { class: "viur-shop-item-view-image-wrap" }, ss = {
  class: "viur-shop-item-view-carousel-thumbnails",
  navigation: "",
  loop: ""
}, is = ["alt", "src"], rs = { class: "viur-shop-item-view-thumbnails" }, os = { class: "viur-shop-item-view-thumbnails-scroller" }, ns = ["alt", "src"], as = { class: "viur-shop-item-view-info-wrap" }, ls = { class: "viur-shop-item-view-headline" }, cs = { class: "viur-shop-item-view-price" }, hs = { class: "viur-shop-item-view-btn-wrap" }, ds = { class: "viur-shop-item-view-item-grid" }, us = {
  __name: "ItemView",
  setup(s) {
    const t = se(), e = Jt({
      item: {}
    ...
    return Yt(async () => {
      ...
      p("div", ts, [
        ...
        p("div", as, [
          p("h1", ls, ht(e.item.shop_name), 1),
          o[3] || (o[3] = p("h2", { class: "viur-shop-item-view-subline" }, "B 21 x H 6,5 x T 19 cm", -1)),
          p("div", cs, ht(e.item.shop_price_retail) + " € ", 1),
          o[4] || (o[4] = p("div", { class: "viur-shop-item-view-paragraph" }, " Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. ", -1)),
          p("div", hs, [
            p("sl-button", {
              size: "small",
              ...
              variant: "primary",
              title: "Add to cart",
              onClick: o[0] || (o[0] = te((n) => r.cartStore.addToCart(r.item.key, r.cartStore.state.currentCart), ["stop"]))
            }, o[1] || (o[1] = [
              p("sl-icon", {
                name: "bag-plus",
                slot: "prefix"
            ...
            o[2] || (o[2] = p("sl-button", {
              ...
              dt(" Auf die Wunschliste ")
            ], -1))
          ])
        ])
      ]),
      o[5] || (o[5] = p("br", null, null, -1)),
      o[6] || (o[6] = p("h1", { class: "viur-shop-item-view-headline" }, "Ähnliche Artikel", -1)),
      p("div", ds, [
        ee(ie, {
          item: e.item
        }, null, 8, ["item"])
...
}, _s = /* @__PURE__ */ re(us, [["__scopeId", "data-v-720fb199"]]);
export {
  _s as default
};

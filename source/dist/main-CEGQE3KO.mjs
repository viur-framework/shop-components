...
import { defineComponent as D, inject as O, reactive as w, openBlock as m, createElementBlock as h, normalizeClass as ye, createElementVNode as i, renderSlot as Ge, pushScopeId as M, popScopeId as z, Fragment as E, createCommentVNode as _, toDisplayString as B, onMounted as R, ref as F, readonly as at, getCurrentScope as st, onScopeDispose as lt, unref as q, computed as S, watchEffect as ce, renderList as U, watch as ae, withDirectives as J, vModelText as le, getCurrentInstance as rt, resolveComponent as se, createBlock as T, vShow as ve, withModifiers as de, createTextVNode as C, shallowRef as G, provide as ie, onBeforeMount as ee, useCssVars as ot, Transition as it, withCtx as ut, createVNode as dt, Teleport as Ze, resolveDynamicComponent as ct, mergeProps as mt } from "vue";
...
const ms = /* @__PURE__ */ I(ke, [["render", cs], ["__scopeId", "data-v-46c45785"]]), oe = $e("cartstore", () => {
...
}, ge = (e) => (M("data-v-8a06be60"), e = e(), z(), e), gs = {
  horizontal: "",
  ...
  Ss
], ks = { class: "viur-shop-cart-leaf-quantity" }, ws = { class: "viur-shop-cart-leaf-unitprice" }, Es = /* @__PURE__ */ ge(() => /* @__PURE__ */ i("div", { class: "viur-shop-cart-leaf-label" }, "Stückpreis", -1)), As = ["value"], Is = { class: "viur-shop-cart-leaf-price" }, Cs = /* @__PURE__ */ ge(() => /* @__PURE__ */ i("div", { class: "viur-shop-cart-leaf-label" }, "Gesamtpreis", -1)), Os = ["value"], js = {
  __name: "CartLeaf",
  props: {
...
}, _l = /* @__PURE__ */ I(Sl, [["__scopeId", "data-v-0e63188d"]]), kl = {}, he = (e) => (M("data-v-36ccc280"), e = e(), z(), e), wl = { class: "bind" }, El = /* @__PURE__ */ he(() => /* @__PURE__ */ i("h1", { class: "headline" }, "Vielen Dank für Ihre Bestellung", -1)), Al = /* @__PURE__ */ he(() => /* @__PURE__ */ i("br", null, null, -1)), Il = /* @__PURE__ */ he(() => /* @__PURE__ */ i("p", { class: "paragraph" }, [
  /* @__PURE__ */ i("strong", null, "Ihre Bestellnummer:"),
  /* @__PURE__ */ C(" 123345670 ")
], -1)), Cl = /* @__PURE__ */ he(() => /* @__PURE__ */ i("p", { class: "paragraph" }, [
...
function jl(e, n) {
  return m(), h("div", wl, Ol);
}
const Bl = /* @__PURE__ */ I(kl, [["render", jl], ["__scopeId", "data-v-36ccc280"]]), Ae = (e) => (M("data-v-b68a2bfa"), e = e(), z(), e), Dl = /* @__PURE__ */ Ae(() => /* @__PURE__ */ i("h2", { class: "viur-shop-form-headline headline" }, "Nutzterdaten", -1)), Vl = /* @__PURE__ */ Ae(() => /* @__PURE__ */ i("h2", { class: "viur-shop-form-headline headline" }, "Lieferadresse", -1)), Nl = { key: 0 }, Rl = /* @__PURE__ */ Ae(() => /* @__PURE__ */ i("h2", { class: "viur-shop-form-headline headline" }, "Rechnungsadresse", -1)), Ll = {
...
}, Ul = /* @__PURE__ */ I(Ll, [["__scopeId", "data-v-b68a2bfa"]]), te = (e) => (M("data-v-a4accf28"), e = e(), z(), e), Tl = /* @__PURE__ */ te(() => /* @__PURE__ */ i("h2", { class: "viur-shop-form-headline headline" }, "Nutzterdaten", -1)), Pl = /* @__PURE__ */ te(() => /* @__PURE__ */ i("h2", { class: "viur-shop-form-headline headline" }, "Lieferadresse", -1)), Ml = ["onSlChange", "onSlClear", "label"], zl = ["value"], Wl = { key: 0 }, ql = /* @__PURE__ */ te(() => /* @__PURE__ */ i("h2", { class: "viur-shop-form-headline headline" }, "Rechnungsadresse", -1)), Fl = /* @__PURE__ */ te(() => /* @__PURE__ */ i("sl-icon", {
  name: "x-lg",
  slot: "prefix"
}, null, -1)), Kl = [
  Fl
], Hl = /* @__PURE__ */ te(() => /* @__PURE__ */ i("sl-icon", {
  name: "plus-lg",
  slot: "prefix"
}, null, -1)), Gl = /* @__PURE__ */ te(() => /* @__PURE__ */ i("sl-icon", {
  slot: "icon",
  name: "exclamation-triangle"
}, null, -1)), Zl = /* @__PURE__ */ te(() => /* @__PURE__ */ i("br", null, null, -1)), Jl = {
      ...
      return m(), h(E, null, [
        ...
        (m(!0), h(E, null, U(t.shippingAdressAmount, (g) => (m(), h("div", { key: g }, [
          i("sl-select", {
            ...
            (m(!0), h(E, null, U(q(n).state.carts, (b, y) => (m(), h("sl-option", { value: y }, B(b.info.name), 9, zl))), 256))
          ], 40, Ml),
...
}, Ql = /* @__PURE__ */ I(Jl, [["__scopeId", "data-v-a4accf28"]]), xe = {
  __name: "ExampleUsage",
  setup(e) {
    const n = oe(), t = S(
...
function er(e, n, t, l, s, o) {
  return m(), h("div", xl, "View " + B(e.route.path) + " is missing.", 1);
}
const tr = /* @__PURE__ */ I(Xl, [["render", er]]), nr = [
  {
    path: "/:pathMatch(.*)*",
    name: "view_missing",
    component: tr
  },
  {
    ...
    name: "CategoryView",
    component: () => import("./CategoryView-BxEb73ST.mjs")
  },
  {
    path: "/shop/item/:item",
    name: "itemView",
    component: () => import("./ItemView-BKuY9pbw.mjs")
  },
  {
    path: "/shop/cart/view",
    name: "CartView",
  ...
  },
  {
    path: "/shop/order/",
    name: "OrderView",
    component: () => Promise.resolve().then(() => Yl)
  },
  {
...
const ar = ft(), cr = {
  install(e) {
    e.component("CartView", we), e.component("ExampleUsage", xe), e.component("ConfirmView", Ee), e.use(ar);
  }
};
export {
  we as C,

export default {
  ...
  viur: {
    shop: {
      ...
      order_message:
        'Nous avons bien reçu votre commande et nous allons la traiter dans les plus brefs délais.<br /> Vous recevrez une confirmation par e-mail dans quelques minutes',
      order_paid: 'Nous avons bien reçu votre paiement',
      order_payment_pending:
        'Votre paiement a été initié. Le montant sera débité de votre compte dans les prochains jours ouvrés.',

export default {
  ...
  viur: {
    shop: {
      ...
      order_message:
        'Wir haben Ihre Bestellung erhalten und werden diese schnellstmöglich bearbeiten.<br /> Sie erhalten in wenigen Minuten eine Bestätigung per E-Mail.',
      order_paid: 'Ihre Zahlung ist bei uns eingegangen.',
      order_payment_pending:
        'Ihre Zahlung wurde angestoßen. Der Betrag wird in den nächsten Werktagen von Ihrem Konto abgebucht.',

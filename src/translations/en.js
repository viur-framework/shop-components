export default {
  ...
  viur: {
    shop: {
      ...
      order_message:
        'We have received your order and will process it as soon as possible.<br /> You will receive a confirmation email in a few minutes.',
      order_paid: 'Your payment has been received.',
      order_payment_pending:
        'Your payment has been initiated. The amount will be debited from your account within the next few business days.',

  ...
  <div class="viur-shop-item-wrapper">
    ...
    >
      <img
        ...
        slot="image"
        :src="
          getImage(item?.shop_image ? item.shop_image : undefined, shopStore.state.serving_url_params.CartItemSmall)
        "
      />
      <h4
      ...
      <div class="viur-shop-cart-leaf-quantity-row">
        <dialog-Button
          class="viur-shop-cart-leaf-delete"
          variant="danger"
          outline
          :disabled="!edit"
        >
    ...
    <div
      class="loading"
      v-if="shopStore.state.cartIsUpdating"
    >
